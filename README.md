...
<br/>证书下载地址
```
https://raw.githubusercontent.com/chaoji2020/test/main/mb3admin.com.cert.pem
https://raw.githubusercontent.com/chaoji2020/test/main/mb3admin.com.key.pem
```
<br><img src="https://github.com/chaoji2020/test/blob/main/cert0.png"><br>
<br/>3. 保存后在配置中将mb3admin.com的证书设置为刚导入的的证书
<br><img src="https://github.com/chaoji2020/test/blob/main/cert1.png"><br>
...
以root用户执行命令：<br/>
</p><pre><code>wget -N --no-check-certificate "https://raw.githubusercontent.com/chaoji2020/test/main/embyonekey.sh" && chmod +x embyonekey.sh && ./embyonekey.sh</code></pre>
...
```
https://raw.githubusercontent.com/chaoji2020/test/main/guomi.cer 
```
下载此链接文件名为guomi.cer的证书文件后安装相应设备上

Windows请安装此目录下
<br/>![](https://github.com/chaoji2020/test/blob/main/window.png)
